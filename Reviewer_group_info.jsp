...
System.out.println("INSIDDDDDDDDDDDDEEEE"+no);

session.setAttribute("Rev_grp_num",no);
%>
<input style="margin-left:10%" class="button" type="submit" name="button" value="See group weekly log">
<input style="margin-left:10%" class="button" type="submit" name="button" value="Evaluate students" >
</form> 
