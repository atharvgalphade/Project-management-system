...
<font size="5"><b>Your deliverables for review 1</b></font>
<div class="card">
  <div class="container">
    <h3 align="center"><b>Deliverables</b></h3> 
    <h4><ul> 
    	<li>Problem Statement / Title<br>    
        <li> Purpose, Scope, Objectives<br>
        <li> Abstract (System Overview)<br> 
         <li>Introduction (Architecture and High-level Design)<br> 
        <li> Literature Survey<br>
        <li> References<br> 
        <li> Project Plan 1.0 (Gantt Chart)<br>
        </ul>
</h4> 
</div>
</div>

<h3>Uploaded Abstract</h3>
<table>
<%
...
<td><b><a href="<%= rev1_obj.getProject_report()  %>"download></b>
...
<form action="Form_submit" method="post" enctype="multipart/form-data">
  ...
  <input type="submit" class="button" name="button" value="Submit deliverable for review1">
</form>
