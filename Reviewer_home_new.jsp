...
<body>
	<ul>
        <li><a href="">Reviewer Home</a></li>
        
        
        <li style="float:right"><a class="active" href="Logout">Logout</a></li>
      </ul>
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('assets/img/desk.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand text-center">
            <h1><b>Project Based Seminar</b></h1>
            <h1 class="title text-center">Reviewer's Page</h1>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
            function callServlet( k,r) 
            {
            	if(r==1)
            	{
                	document.forms[0].action = "Form_submit?Id="+k+"&button=Reviewer_group_home";
...
<% 
	...
	ArrayList<Group> groups=(ArrayList<Group>)session.getAttribute("Groups_under_reviewer");
...
%>	
  ...
  <div class="flip-card-inner">
    ...
    <b class="GFG"> Group <br><br> <%=grp_obj.getGroup_id()%></b>
            ...
            <img src="Pics/download1.jpg" alt="Avatar" style="width:320px;height:280px"  >
          </div>
          <div class="flip-card-back" >
            <br />
            <b>
           <font size=4px> Group Id:<%=grp_obj.getGroup_id() %><br><br>
